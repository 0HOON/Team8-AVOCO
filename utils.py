...
instructions = {
  ...
  '''
  Identify any inconsistencies among reviewers and summarize them using the following format exactly for each inconsistency:
  ...
  "find_inconsistency_in_pdf": 
  '''
  You are a research assistant tasked with identifying the exact text from a research paper corresponding to a specific description of its content. You will be provided with two inputs: Paper Text: The full text of the paper (paper_text). \
